				...
				<div className={ classes.tableBody }>
					{ votes && votes.length > 0 &&
							votes.filter((vote) => {
								...
								const	yesPerc = BigNumber(vote.vote.yea).times(100).div(BigNumber(vote.vote.yea).plus(vote.vote.nay)).toFixed(2);
								const	quorumPerc = BigNumber(vote.vote.yea).plus(vote.vote.nay).times(100).div(vote.vote.votingPower).toFixed(2);

								return (
									<div key={vote.index} className={ classes.tableRow }>
